                                                ...
                                                <table class="table border bordered">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th class="">Stock Quantity (Pcs)</th>
                                ...
                                <div class="cell colspan2 well">
                                    ...
                                    <div class="row cells6">
                                        ...
                                        <div class="cell colspan4 hidden" id="msgvr">
                                            <p class='alert alert-danger uppercase'>coefficient and actual cash banked can't be null</p>
                                        </div>
                                    </div>
