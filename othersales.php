...
$sqlproduits = "SELECT * FROM produit "
        ...
        . " AND  typeproduit  IN ( SELECT id FROM typeproduit WHERE intitule = 'GAZ') ";
        ...
        <div class="modal-content">
            ...
            <div class="modal-body"> 
                ...
                <div class="input-control select">
                    ...
                    <select id="produitUP" name="produitUP" readonly="true">
                        <?php
                ...
                <div class="input-control text">
                    <input type="text" name="prixvente" id="prixventeUP"/>
                </div>
    ...
    <div class="row cells5">
        ...
        <div class="cell colspan4">
            <div class="row cells3">
                <!--        ---------pump ------------------->
                <div class="cell well"> 
                    <h4 class="text-light">OTHER SALES INTERFACE</h4><br/>
                    <form method="post" onsubmit="return false;" id="salesform">
                        ...
                        <label class="text-light">Sale's Quantity</label><br/>
                        <div class="input-control text">
                            <input type="text" name="qtevendu" id="qtevendu" placeholder="Sales Pcs"/>
                            <span class="button" id="unite"></span>
                        </div><br/>
                        <label class="text-light">Product's price</label><br/>
                        <div class="input-control text">
                            <input type="text" name="prixvente" id="prixvente" placeholder="Price of product"/>
                        </div>
                        <div>
                ...
                <div class="cell colspan2">
                    ...
                    <table class="dataTable border bordered" data-role="datatable" data-searching="true">
                        ...
                        <tbody id="tablepump">
                            ...
                            $sql = "SELECT vt.id as vtid, pd.id as id, pd.intitule as pdintitule, "
                                    ...
                                    . " WHERE  typeproduit  IN ( SELECT id FROM typeproduit WHERE intitule = 'GAZ') "
                                    . " AND pd.station =:station";


                            $req = $pdo->prepare($sql);
                            $req->execute(array("station" => $station));
                            $venteSummary = $req->fetchAll(PDO::FETCH_OBJ);
    ...
    $(document).ready(function () {
        ...
        $("#updateVente").click(function () {
            ...
            if (qtevendu !== '' && datevente !== '' && prixvente !== '' && prixvente !== '') {
                ...
                if(parseFloat(qtevendu)>  parseFloat(stockproduit)) {
                    $("#resuUpdate").html("This Quantity More is than Our Stock").addClass("alert alert-danger");
                    return false;
                }
                $.ajax({
                    url: "traitement/ajaxsales.php",
